...
directory_info = {
    'Справочник': 'Основные справочники системы, содержащие нормативно-справочную информацию предметной области. Эти таблицы используются как базовые данные для работы всей системы.',
    'Ассоциации': 'Промежуточные таблицы связей между основными сущностями системы. Обеспечивают многие-ко-многим связи между справочниками.',
    ...
    'Разное': 'Сервисные и административные функции системы для управления настройками и безопасностью.',
